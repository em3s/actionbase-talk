...
<div class="caption">그 규모에서 잘 견뎌낸 조합 · 서비스가 커지면서 다음 단계가 필요해진 시점</div>
...
<div class="caption"><strong>처음부터 옳았던 설계가 아니라</strong> — 운영되면서 한 칸씩 자란 흔적</div>
...
<div class="pull">
완벽한 시스템을 만든 게 아니라,<br/>
<strong>틀려도 고칠 수 있는</strong> 시스템을 만들었습니다.
</div>
...
어느 layer 하나로는 충분하지 않았습니다. (잠시 멈춤) 완벽한 시스템을 만든 게 아니라, 틀려도 고칠 수 있는 시스템을 만들었습니다.
...
Note:
틀려도 고칠 수 있는 길을 걸어왔습니다. 오늘은 그 길의 한 구간이었어요. 다음 두 분이 그 다음 구간을 안내해 주실 거예요. 감사합니다.
